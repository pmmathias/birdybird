...
const strings = {
  de: {
    ...
    'calib.skipShake': 'Überspringen',
    'calib.detected': 'Erkannt!',
    'calib.live.label': 'Live-Sensor',
    'calib.live.delta': 'Δ zur Ruhe',
    'calib.live.waiting': 'Warte auf Sensor…',
    'calib.test.title': 'Kurzer Probeflug',
    'calib.test.text': 'Neige dein Handy in alle Richtungen.\nFliegt der Vogel so, wie du es erwartest?',
    'calib.test.confirm': '✓ Passt — weiter',
    'calib.test.redo': '↻ Neu kalibrieren',
