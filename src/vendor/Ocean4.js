...
// NOTE: Adapted for birdybird — StorageTexture is a WebGPU-only class, only
// exported from `three/webgpu`. The original file imported everything from
// `three` which fails under modern bundlers.
import {
	ClampToEdgeWrapping,
	DataTexture,
	FloatType,
